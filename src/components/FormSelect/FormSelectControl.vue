...
import type { FormSelectControlProps } from './types'
...
const emit = defineEmits<{
  change: [value: FormSelectControlProps['value'], option: unknown]
  'update:value': [value: FormSelectControlProps['value']]
}>()
...
const updateChoice = (value: FormSelectControlProps['value']) => {
