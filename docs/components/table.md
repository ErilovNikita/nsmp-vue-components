...
| Расположение | `pagination.position` |
| --- | --- |
...
| `pagination` | `false \| TablePaginationConfig` | 20 строк, снизу слева | Настройки пагинации; `position` задаёт размещение сверху и/или снизу, `false` отключает пагинацию |
